...
(function () {
  ...
  function closeSheet() {
    ...
    setTimeout(function () { sheet.classList.add('u-hidden'); }, 220);
  }
  ...
  function buildTaskItem(text) {
    ...
    li.innerHTML =
      '<label class="c-item__label">' +
        '<input class="c-item__check" type="checkbox" aria-label="סמן משימה" />' +
  ...
  if (taskList) {
    ...
    taskList.addEventListener('change', function (e) {
      ...
      if (li) li.addEventListener('animationend', onEnd, { once: true });
    });
  }
