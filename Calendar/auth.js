...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    loginForm.addEventListener('submit', function (e) {
      ...
      var ok = true;
      if (!validateEmail(email)) { $('loginEmailErr').textContent = 'אימייל לא תקין'; ok = false; }
    ...
    registerForm.addEventListener('submit', function (e) {
      ...
      if (!validateEmail(email)) { $('regEmailErr').textContent = 'אימייל לא תקין'; ok = false; }
      if (!validatePassword(pass)) { $('regPasswordErr').textContent = 'סיסמה חייבת להיות באורך 8+ ולכלול ספרה'; ok = false; }
