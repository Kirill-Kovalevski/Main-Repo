...
(function () {
  ...
  function renderWeek() {
    ...
    for (var i = 0; i < 7; i++) {
      ...
      box.dataset["goto"] = ymd; // header: [day-name] [counter-center] [date-number]
  ...
  function renderMonth() {
    ...
    for (var i = 0; i < 42; i++) {
      ...
      cell.appendChild(num); // tiny counter at top-left (won't overlap the number)
